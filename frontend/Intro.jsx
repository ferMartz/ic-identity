...
export function Intro() {
  ...
  const handleGetPrincipal = async () => {
    let res = await actor.displayIdentity()
    console.log(res)
  }
  console.log("intro actor dfx", counter)
  console.log("intro actor local", actor)
  return (
    <>
      <header className="App-header">
        ...
        <button className="demo-button" onClick={handleGetPrincipal}>
          get principal
        </button>
